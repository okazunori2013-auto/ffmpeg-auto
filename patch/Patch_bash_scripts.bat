...
rem for fix build
sed -i 's!https://github.com/ccxvii/mujs.git!https://github.com/ccxvii/mujs.git#commit=bb6a85a31c46f82577bacc1cc21d3c3b9df02b82!g media-autobuild_suite/build/media-suite_deps.sh
